...
const razorpayPaymentButtonUrl = `https://pages.razorpay.com/${razorpayPaymentButtonId}`;
...
function mountRazorpayPaymentButton() {
  ...
  target.innerHTML = `<a class="primary razorpay-fallback-link" href="${escapeHtml(razorpayPaymentButtonUrl)}" target="_blank" rel="noopener">Donate Now</a>`;
